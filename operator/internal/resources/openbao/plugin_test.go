...
func TestPluginDownloadURL(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			os:      "linux",
			arch:    "amd64",
			wantURL: "https://github.com/Bidon15/banhbaoring/releases/download/v1.0.0/banhbaoring-secp256k1_linux_amd64",
		},
		{
			version: "2.0.0",
			os:      "linux",
			arch:    "arm64",
			wantURL: "https://github.com/Bidon15/banhbaoring/releases/download/v2.0.0/banhbaoring-secp256k1_linux_arm64",
		},
	}
