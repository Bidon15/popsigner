...
func CertDownloadModal(bundle *models.CertificateBundle) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div class=\"max-w-2xl w-full bg-black border border-[#333300]\"><!-- Header --><div class=\"flex items-center justify-between p-5 border-b border-[#333300]\"><h3 class=\"text-lg font-bold text-[#33FF00] uppercase flex items-center gap-2\"><span class=\"drop-shadow-[0_0_10px_#33FF00]\">✓</span> CERTIFICATE_GENERATED</h3><button @click=\"$dispatch('modal-close'); htmx.trigger('#main-content', 'refresh')\" class=\"p-1.5 text-[#666600] hover:text-[#FFB000] hover:bg-[#FFB000]/10 transition-colors\"><svg class=\"w-5 h-5\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M6 18L18 6M6 6l12 12\"></path></svg></button></div><!-- Body --><div class=\"p-5 space-y-6\"><!-- Warning Banner --><div class=\"p-4 bg-[#FFB000]/10 border border-[#FFB000] relative\"><div class=\"absolute inset-0 pointer-events-none opacity-10\n\t\t\t\t            bg-[repeating-linear-gradient(0deg,transparent,transparent_1px,rgba(0,0,0,0.3)_1px,rgba(0,0,0,0.3)_2px)]\"></div><div class=\"relative flex items-start gap-3\"><span class=\"text-[#FFB000] text-xl drop-shadow-[0_0_5px_#FFB000]\">⚠</span><div><p class=\"font-bold text-[#FFB000] uppercase text-sm\">DOWNLOAD NOW - ONE TIME ACCESS</p><p class=\"text-sm text-[#CC8800] mt-1\">The private key will not be shown again. Make sure to download and securely store these files.</p></div></div></div><!-- Download Buttons --><div class=\"grid grid-cols-3 gap-4\"><a href=\"")
		if templ_7745c5c3_Err != nil {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "\" download=\"client.crt\" class=\"flex flex-col items-center p-4 bg-[#0A0A0A] border border-[#333300] \n\t\t\t\t          hover:border-[#33FF00] hover:shadow-[0_0_10px_rgba(51,255,0,0.3)] transition-all group\"><span class=\"text-3xl mb-2 group-hover:drop-shadow-[0_0_8px_#33FF00] transition-all\">📜</span> <span class=\"text-sm font-bold text-[#33FF00] uppercase\">client.crt</span> <span class=\"text-xs text-[#666600]\">Certificate</span></a> <a href=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "\" download=\"client.key\" class=\"flex flex-col items-center p-4 bg-[#0A0A0A] border border-[#333300] \n\t\t\t\t          hover:border-[#FFB000] hover:shadow-[0_0_10px_rgba(255,176,0,0.3)] transition-all group\"><span class=\"text-3xl mb-2 group-hover:drop-shadow-[0_0_8px_#FFB000] transition-all\">🔑</span> <span class=\"text-sm font-bold text-[#FFB000] uppercase\">client.key</span> <span class=\"text-xs text-[#666600]\">Private Key</span></a> <a href=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
