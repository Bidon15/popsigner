...
func certificateRow(cert models.Certificate) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 13, "</p><span class=\"text-[#333300]\">│</span><p class=\"text-sm text-[#666600]\">Issued ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 14, "</p><span class=\"text-[#333300]\">│</span><p class=\"text-sm text-[#666600]\">Expires ")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if isExpiringSoon(cert) && !cert.IsRevoked() {
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 17, "<span class=\"px-2 py-0.5 text-xs font-bold bg-[#FFB000]/10 text-[#FFB000] border border-[#FFB000]\">⚠ EXPIRING SOON</span>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
